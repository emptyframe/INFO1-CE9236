...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        for (TileView *tileView in _array) {
        ...
        TileView *tileView = [_array lastObject];
...
{
 // Drawing code
    CGPoint position = CGPointMake(-50, -140); 
    NSString *string = @"Solution";
	UIFont *font = [UIFont systemFontOfSize: 80];
	[string drawAtPoint: position withFont: font];
}
